...
const TEST_DATA = {
  ...
  captains: [
    ...
    },
    {
      ...
      phoneNumber: `+1555124${Math.floor(Math.random() * 1000000)
        .toString()
        .padStart(6, "0")}`,
      password: "TestCaptain123!",
      longitude: -74.01,
    ...
    },
    {
      ...
      phoneNumber: `+1555125${Math.floor(Math.random() * 1000000)
        .toString()
        .padStart(6, "0")}`,
      password: "TestCaptain123!",
      longitude: -74.015,
...
async function updateCaptainLocations() {
  ...
  try {
    const locationUpdates = [
      { captainIndex: 0, longitude: -74.02, latitude: 40.72 },
      { captainIndex: 1, longitude: -74.025, latitude: 40.722 },
    ];
...
async function validateWorkingHoursUpdate() {
  ...
  try {
    ...
    const updatedCaptain = response.data.captains.find(
      (captain) => captain.id === STATE.captainIds[0],
    );
    ...
    if (updatedCaptain) {
      ...
      if (
        updatedCaptain.workingHoursStart === "07:00" &&
