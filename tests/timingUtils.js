...
class TimingTracker {
  ...
  startTracking() {
    ...
    console.log(`⏱️  Test timing started at: ${new Date(this.startTime).toISOString()}`);
  }
  ...
  endOperation() {
    ...
    console.log(`⏱️  Completed operation: ${this.currentOperation.name} (${duration}ms)`);
    this.currentOperation = null;
  ...
  getStats() {
    ...
    const sortedTimings = [...this.timings].sort((a, b) => b.duration - a.duration);
